...
<body style="background-color: #EBEBEB">
	<div class="container" style="width: 80%; background-color: #EBEBEB;">
		...
		<div class="row" style="background-color: #EBEBEB;">
			<h2>
				<b><p style="display: table; margin: 15px 0 0 12px;">My
						Review</p></b>
			</h2>
			<!--  팁 작성 끝 -->
			...
			<div class="col-md-3" style="height: 60%">
				...
				<p>
					<input type="image" src=""> <font size="3"><b>김예림</b></font>&nbsp;&nbsp
					<font size="2">건성</font>&nbsp;&nbsp <font size="2">21호</font>
				<hr>
	...
	<div class="modal fade review-modal-lg" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<jsp:include page="../hangOut/DetailHangOut.jsp" flush="true">
