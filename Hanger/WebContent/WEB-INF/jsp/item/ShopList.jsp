				...
				<div class="col-sm-6 col-md-2" style="display:table;margin-left:3px;">
					<div class="thumbnail" style = " width:205px">
						...
						<div class="caption">
							...
							<p>
							<p><font size = "3"><font color = "orange"><b>미네랄 모이스처 파운데이션 C2호 핑크 내추럴 베이지</b></font></font></p>
							<p>★★★★★
							<p>가격	&nbsp;&nbsp;27,7000
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<span class="glyphicon glyphicon-pencil" aria-hidden="true" ></span><span class="badge" style = "float:right">20</span>
						</div>
					</div>
				</div>
				<%
