...
<body class="ourBody" style="background-color: #EBEBEB">
	<div class="container">
		...
		<div class="thumbnail">
			<div class="header"
				style="width: 980px; height: 500px; margin-left: 80px">
				<div class="product-info"
					style="background-color: white; width: 980px; height: 500px; border: 1px gray">
					<div class="product"
					...
					<div class="product-subject"
						style="width: 447px; height: 460px; float: right">
						<div class="subTitle">
							<p>
							<h5>2015 S/S 아방가르드 디자인의 수분 크림 팩트</h5>
							</p>
						</div>
						<div class="titleFW">
							<p>
						...
						<ul class="nav nav-pills">
							<a>
								<li role="presentation" class="btn btn-default">무료배송</li>
							</a>
							<a>
								<li role="presentation" class="btn btn-default">업체배송</li>
							</a>
						</ul>
						...
						<div class="productPrice"
							style="width: 200px; height: 50px; align: right">
							총 상품 금액 :<font size="5"><font color="red">19,800</font></font> 원
						</div>
						<div class="buy" align="center">

							<ul class="nav nav-pills">
								<li role="presentation" class="butn btn-default"
									style="width: 228px; height: 40px; align: center; margin-left: 120px"><a
									href="WisiList.jsp"><B>구매하기 / 담기</B></a></li>
							</ul>
						</div>
					</div>
				</div>
		...
		<div class="thumbnail" style="width: 100%; height: 300px;">
			<div class="product-munsu" style="width: 100%; height: 300px;">
				<BR>
				<div class="title" style="margin-left: 22px;">
					<font size="4"><B>상품 정보</B></font>
				</div>
				...
				<div role="tabpanel">
					...
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane active" id="home">이곳은
							화장품의 설명이 들어가는 곳 입니다.</div>
						<div role="tabpanel" class="tab-pane" id="profile">제품명 : 에뛰드
							하우스 진주 광채 오로라 에센스 로션</div>
						<div role="tabpanel" class="tab-pane" id="messages">테이블을 써서
							표 형식으로 작성해도 됩니다..</div>
		...
		<!-- 팔로우 리뷰 작성 시작 -->
		<div class="thumbnail"
			style="background-color: white; width: 100%; height: 1200px;">
			<BR>
			<div class="title" style="margin-left: 22px;">
		...
		<div class="thumbnail"
			...
			%>
			<div class="review"
				style="background-color: white; width: 100%; height: 100px;">
				<div class="profile"
					style="width: 100px; height: 100px; float: left; margin-left: 2%">
					<img src="/assets/images/song.jpg"
						style="width: 100px; height: 100px;" />
				</div>
				<div class="name"
					style="width: 400px; height: 30px; float: left; margin-left: 20px;">
					제목 : 이 상품 너무 좋아요 (<b>dofwk2@***** / 2015-05-29</b>)
				</div>
				<br> <BR>
				<div class="name"
					style="width: 700px; height: 60px; float: left; margin-left: 20px;">내용
					:</div>
			</div>
			<hr style="width: 100%;">
			<%
		...
		<div class="thumbnail"
			...
			<div class="review" style="width: 100%; height: 100px;">
				...
				<br> <BR>
				<div class="name"
					style="width: 650px; height: 60px; float: left; margin-left: 20px;">내용
					:</div>
			</div>
			<hr style="width: 100%;">
			<%
