   ...
   function joinBtn() {
      ...
      if (trim(f.joinId.value) != "") {
         ...
         if ((f.joinId.value).indexOf("@") == -1
               || (f.joinId.value).indexOf(".") == -1
               || (f.joinId.value).indexOf(".") < (f.joinId.value)
                     .indexOf("@") || isNum((f.joinId.value).charAt(0))) {
...
<body>
   <CENTER>
      <div class="form-horizontal" role="form">
         ...
         <form role="form" id="updateForm" name="updateForm" method="POST"
            action="/updateUserResult.hang" enctype="multipart/form-data">
            <INPUT type="hidden" name="picPath" value="" /> <INPUT
               type="hidden" name="picOrgName" value="<%=userPicOrgName%>" /> <INPUT
               type="hidden" name="picSaveName" value="<%=userPicSaveName%>" />
            <INPUT type="hidden" name="picSize" value="" /> <INPUT
               type="hidden" name="idCheckYn" value="N" />
            <div class="col-md-12">
               <h1>Join</h1>
               <H4>필수 정보</H4>
               <BR>
            ...
            <div class="form-group">
               ...
               <div class="col-sm-10">
                  <input type="text" class="form-control" id="Email" name="joinId"
                     value="<%=userId%>" readonly>
               </div>
            </div>
            <div class="form-group">
               <label for="password1" class="col-sm-2 control-label">Password
                  : </label>
               <div class="col-sm-10">
                  <input type="password" class="form-control" id="password1"
                     name="pass1" value="<%=userPwd%>">
               </div>
            </div>

            <div class="form-group">
               <label for="password2" class="col-sm-2 control-label">Pass
                  Confirm : </label>
               <div class="col-sm-10">
                  <input type="password" class="form-control" id="password2"
                     name="pass2" value="<%=userPwd%>">
               </div>
            </div>
            ...
            <div class="form-group">
               ...
               <div class="col-sm-10">
                  <input type="text" class="form-control" id="phone" name="mobile"
                     value="<%=userPhone%>" maxlength="11">
               </div>
            </div>

            <div class="form-group">
               <label for="optGender" class="col-sm-2 control-label">Gender
                  : </label>
               <div class="col-sm-10">

                  <label class="radio-inline"> <input type="radio"
                     name="gender" id="optGenderWomen" value="F"
                     <%if (userGender.equals("F")) {%> checked <%}%>> Female
                  </label> <label class="radio-inline"> <input type="radio"
                     name="gender" id="optGenderMan" value="M"
                     <%if (userGender.equals("M")) {%> checked <%}%>> Male
                  </label>
            ...
            <div class="form-group">
               <label for="txtBirth" class="col-sm-2 control-label">BirthDate
                  : </label>
               <div class="col-sm-10">
                  <div class="row">
                     <div class="col-sm-3">
                        <select name="year" id="dobMonth" class="form-control"
                           style="width: 100px;">
            ...
            <div class="form-group">
               ...
               <div class="col-sm-10">
                  <input type="text" class="form-control" id="question"
                     name="question" value="<%=userQuestion%>">
               </div>
            </div>

            <div class="form-group">
               <label for="answer" class="col-sm-2 control-label">Answer :
               </label>
               <div class="col-sm-10">
            ...
            <div class="form-group">
               <label for="zipcode1" class="col-sm-2 control-label">Postcode
                  :</label> <INPUT type="text" name="zipCode1" class="form-control zip1"
                  id="zipCode1" size="5" value="<%=userPostCode1%>" readonly>
               <INPUT type="text" name="zipCode2" class="form-control zip1"
                  id="zipCode2" size="5" value="<%=userPostCode2%>" readonly>

               <INPUT type="button" value="Search" class="form-control zip1"
                  style="cursor: pointer" id="zipSearch" onclick="zipcodeBtn()">
            </div>

            <div class="form-group">
               <label for="addr1" class="col-sm-2 control-label"></label> <INPUT
                  type="text" name="addr1" size="40" class="form-control zip2"
                  value="<%=userAddr1%>" readonly>
            </div>
            <div class="form-group">
               <label for="addr2" class="col-sm-2 control-label"></label> <INPUT
                  type="text" name="addr2" class="form-control zip2" size="40"
                  value="<%=userAddr2%>">
            </div>
      </div>
      <div class="form-horizontal form-horizontal1" role="form">
         ...
         <div class="form-group">
            ...
            <div class="col-sm-10">
               <input id="image" type="file" class="input_file" name="image"
                  onchange="readURL(this)"> <span id="imagePreview">
                  <img src="<%=image%>" id="pictureImg"  width="150" height="180"></span>

            </div>
         </div>
         <div class="form-group">
            <label for="skinType" class="col-sm-2 control-label">SkinType
               : </label>
            <div class="col-sm-10">
               <select name="skinType" id="skinType" class="form-control">
                  <option value="000" <%if (userSkinType.equals("000")) {%> selected
                     <%}%>>선택안함</option>
                  <option value="F2003" <%if (userSkinType.equals("F2003")) {%>
                     selected <%}%>>건성</option>
                  <option value="F2002" <%if (userSkinType.equals("F2002")) {%>
                     selected <%}%>>지성</option>
                  <option value="F2001" <%if (userSkinType.equals("F2001")) {%>
                     selected <%}%>>중/복합성</option>
         ...
         <div class="form-group">
            <label for="skintone" class="col-sm-2 control-label">SkinTone
               : </label>
            <div class="col-sm-10">
               <select name="skinTone" id="skinTone" class="form-control">
                  <option value="00" <%if (userSkinTone.equals("00")) {%> selected
                     <%}%>>선택안함</option>
                  <option value="13호" <%if (userSkinTone.equals("13호")) {%> selected
                     <%}%>>13호</option>
                  <option value="21호" <%if (userSkinTone.equals("21호")) {%> selected
                     <%}%>>21호</option>
                  <option value="23호" <%if (userSkinTone.equals("23호")) {%> selected
                     <%}%>>23호</option>
               </select>
            </div>
         </div>
         ...
         <div class="form-group">
            ...
            <div class="col-sm-10 checks">
               <input type="checkbox" name="skinProblem" value="F2004"> 여드름 </label>
                <label class="checkbox-inline"> <input type="checkbox"   name="skinProblem" value="F2005"> 블랙헤드 </label>
                <label class="checkbox-inline"> <input type="checkbox"  name="skinProblem" value="F2006"> 모공   </label>
            </div>
            <label for="skintrouble" class="col-sm-2 control-label"> </label>
            <div class="col-sm-10 checks">
               <label class="checkbox-inline"> <input type="checkbox"    name="skinProblem" value="F2007"> 안티에이징 </label>
               <label class="checkbox-inline"> <input type="checkbox"    name="skinProblem" value="F2008"> 주름 </label>
               <label class="checkbox-inline"> <input type="checkbox"   name="skinProblem" value="F2009"> 홍조   </label>
            </div>
         </div>
