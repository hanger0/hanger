	...
	<div style="width: 100%;"
		...
		<div class="collapse navbar-collapse">
			<ul class="nav navbar-nav navbar-right unpa-navbar-right"
				...
				%>
				<li class="headli"><a href="/myPage.hang"> <span
						class="glyphicon glyphicon-user" style="font-size: 24px"></span>
				</a></li>
				<!-- 알람시작 -->
				<li class="headli"><a href="#"> <span
						class="glyphicon glyphicon-bullhorn" style="font-size: 24px"></span>
				</a></li>
		
				<li class="headli"><a href="/cart.hang"> <span
						class="glyphicon glyphicon-shopping-cart" style="font-size: 24px"></span>
				</a></li>
				
						<li>
					<ul class="nav">
						<li class="dropdown headli"><span class="dropdown-toggle"
							data-toggle="dropdown" aria-expanded="true"
							style="width: 50; height: 54"> <span
								class="glyphicon glyphicon-search" style="font-size: 24px;margin-top:14px;margin-left:7px;cursor:pointer;"></span>
						</span>
				...
				<li class="headli"><a href="/logout.hang"> <span
						class="glyphicon glyphicon-menu-right" style="font-size: 24px"></span>
				</a></li>
				<%
				...
				%>
				<li><a href="/login.hang" class="remove-border"
					style="width: 75px">로그인</a></li>
