	...
	<div class = "search" style = "background-color:yellow;margin-left:40%">
      ...
      <div class="collapse navbar-collapse">
         <ul class="nav navbar-nav navbar-right unpa-navbar-right" style="margin-right: 6%; width: 20%">
            ...
            %>
            <!-- 알람시작 -->
            <li class="headli" style = "margin-left:-30%;">
            	<a href="/myPage.hang">
            ...
            <li class="headli" style="margin-left: 35%; margin-right: 5%">
               <a href="/managerAddItem.hang"> <span
                  class="glyphicon glyphicon-plus" style="font-size: 18px;"></span>
            </a>
            </li>

            <li class="headli"><a href="/logout.hang"> <span
                  class="glyphicon glyphicon-remove" style="font-size: 18px"></span>
            </a></li>
            <%
               } else {
            %>
            <li style="margin-left: 10%; margin-right: 5%"><a
