...
$(function(){
	...
	$("#sizeAddBtn").click(function(){
		$("#sizeForm").append("<input type='text' id='size"+sizeCnt+"' name='size"+sizeCnt+"'>");
		$("#marketPriceForm").append("<input type='text' id='marketPrice"+sizeCnt+"' name='marketPrice"+sizeCnt+"'>");
		$("#sellPriceForm").append("<input type='text' id='sellPrice"+sizeCnt+"' name='sellPrice"+sizeCnt+"'>");
		$("#purchasePriceForm").append("<input type='text' id='purchasePrice"+sizeCnt+"' name='purchasePrice"+sizeCnt+"'>");
		$("#sellMaxNumForm").append("<input type='text' id='sellMaxNum"+sizeCnt+"' name='sellMaxNum"+sizeCnt+"'>");
		$("#stockAmountForm").append("<input type='text' id='stockAmount"+sizeCnt+"' name='stockAmount"+sizeCnt+"'>");
		...
		$("#manufactureDateForm").append("</SELECT>");
		$("#manufactureDateForm").append("<SELECT id='manufactureDay"+ sizeCnt +"' name='manufactureDay"+ sizeCnt + "'>");
		...
		$("#expireDateForm").append("</SELECT>");
		$("#expireDateForm").append("<SELECT id='expireDay"+ sizeCnt +"' name='expireDay"+ sizeCnt + "'>");
